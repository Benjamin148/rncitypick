...
const PickerHeader: FC<IProps> = ({ 
  ...
  return (
    <View style={[{
      flexDirection: 'row', justifyContent: 'space-between', height: 40,
      borderBottomColor: '#e5e5e5', borderBottomWidth: 0.7, backgroundColor: '#F4F4F3'
    }, pickerToolBarStyle]}>
      <TouchableOpacity
        activeOpacity={0.9}
